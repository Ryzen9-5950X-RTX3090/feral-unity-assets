...
public class UI_LazyListItemDetailPanel_AvatarLookSaving : UI_LazyListItemDetailPanel<AvatarLookItemComponent>
{
	[SerializeField]
	...
	public override void Setup(UI_LazyListItem<AvatarLookItemComponent> inDataSrc)
	{
	}
