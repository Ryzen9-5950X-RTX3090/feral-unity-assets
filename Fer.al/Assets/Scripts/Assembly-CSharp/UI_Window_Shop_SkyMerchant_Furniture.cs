...
public class UI_Window_Shop_SkyMerchant_Furniture : UI_Window_Shop_CraftableItem
{
	...
	private struct <OnItemSelected>d__11 : IAsyncStateMachine
	{
		...
		public UI_Window_Shop_SkyMerchant_Furniture <>4__this;
	...
	[SerializeField]
	[Header("Sky Merchant Furniture Shop")]
	private UI_StageSubjectPositioner _stagePositioner;

	private UI_Stage_3DItem_SkyMerchant _itemStage;

	[DebugButton("Open Sky Merchant Furniture Shop", "Shop", true, true)]
	...
	private void OnStageLoaded(UI3DItemStageSkyMerchantLoadedMessage inMessage)
	{
	}

	private void OnStageInitialized(UI3DItemStageSkyMerchantInitializedMessage inMessage)
	{
	}
