...
public class UI_ChatPanel_Private : UI_ChatPanel
{
	...
	private struct <Setup>d__7 : IAsyncStateMachine
	{
		...
		public UI_ChatPanel_Private <>4__this;
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct <SpawnInitialChatItems>d__16 : IAsyncStateMachine
	{
		public int <>1__state;
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct <RequestAdditionalChats>d__17 : IAsyncStateMachine
	{
		public int <>1__state;
	...
	[StructLayout(LayoutKind.Auto)]
	[CompilerGenerated]
	private struct <OnChatChacheChanged>d__18 : IAsyncStateMachine
	{
		public int <>1__state;
	...
	[AsyncStateMachine(typeof(<SpawnInitialChatItems>d__16))]
	protected override void SpawnInitialChatItems()
	{
	}

	[AsyncStateMachine(typeof(<RequestAdditionalChats>d__17))]
	private void RequestAdditionalChats(bool inGetOlder)
	{
	}

	[AsyncStateMachine(typeof(<OnChatChacheChanged>d__18))]
