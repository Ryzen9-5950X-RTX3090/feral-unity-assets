...
public class UI_Window_Shop_SkyMerchant_Clothing : UI_Window_Shop_CraftableItem
{
	[SerializeField]
	[Header("Sky Merchant Clothing Shop")]
	...
	[DebugButton("Open Sky Merchant Clothing Shop", "Shop", true, true)]
