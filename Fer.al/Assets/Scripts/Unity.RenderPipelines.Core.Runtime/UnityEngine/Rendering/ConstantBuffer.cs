...
namespace UnityEngine.Rendering
{
	public class ConstantBuffer
	{
		...
		private class TypedConstantBuffer<CBType> : ConstantBufferBase where CBType : struct
		{
			...
			public void UpdateData(CommandBuffer cmd, [In] ref CBType data)
			{
			}
		...
		public static void PushGlobal<CBType>(CommandBuffer cmd, [In] ref CBType data, int shaderId) where CBType : struct
		{
		}

		public static void Push<CBType>(CommandBuffer cmd, [In] ref CBType data, ComputeShader cs, int shaderId) where CBType : struct
		{
		}

		public static void Push<CBType>(CommandBuffer cmd, [In] ref CBType data, Material mat, int shaderId) where CBType : struct
		{
		}

		public static void UpdateData<CBType>(CommandBuffer cmd, [In] ref CBType data) where CBType : struct
		{
		}
