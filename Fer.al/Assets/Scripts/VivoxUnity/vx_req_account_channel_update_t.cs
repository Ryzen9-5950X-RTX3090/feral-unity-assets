...
public class vx_req_account_channel_update_t : IDisposable
{
	...
	internal vx_req_account_channel_update_t(IntPtr cPtr, bool cMemoryOwn)
	{
	}

	internal static HandleRef getCPtr(vx_req_account_channel_update_t obj)
	{
