...
public class vx_req_sessiongroup_add_session_t : IDisposable
{
	...
	internal vx_req_sessiongroup_add_session_t(IntPtr cPtr, bool cMemoryOwn)
	{
	}

	internal static HandleRef getCPtr(vx_req_sessiongroup_add_session_t obj)
	{
