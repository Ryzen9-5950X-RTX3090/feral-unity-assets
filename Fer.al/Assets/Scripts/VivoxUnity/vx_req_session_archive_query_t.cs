...
public class vx_req_session_archive_query_t : IDisposable
{
	...
	internal vx_req_session_archive_query_t(IntPtr cPtr, bool cMemoryOwn)
	{
	}

	internal static HandleRef getCPtr(vx_req_session_archive_query_t obj)
	{
	...
	public vx_req_session_archive_query_t()
	{
	}
}
