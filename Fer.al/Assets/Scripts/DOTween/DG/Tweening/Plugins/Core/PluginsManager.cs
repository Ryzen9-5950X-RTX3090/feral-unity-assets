...
namespace DG.Tweening.Plugins.Core
{
	internal static class PluginsManager
	{
		...
		public static ABSTweenPlugin<T1, T2, TPlugOptions> GetCustomPlugin<T1, T2, TPlugOptions, TPlugin>() where TPlugOptions : struct, IPlugOptions where TPlugin : ITweenPlugin, new()
		{
			return null;
		}
